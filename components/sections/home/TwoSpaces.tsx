...
const AREAS: Area[] = [
  ...
  },
  {
    ...
    copy: "A historic Grade II listed building at the heart of the grounds, offering elegant indoor function spaces and a beautiful backdrop for weddings and corporate hospitality.",
